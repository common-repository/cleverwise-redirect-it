...
EOM;
	...
	////////////////////////////////////////////////////////////////////////////
		...
		$cw_redirect_it_whats_new=array(
			'2.0'=>'Fixed: Error when searching with no records|Theme changes',
			'1.9'=>'Minor theme changes',
			'1.8'=>'Fixed: "URL To Redirect File" now allows https',
			'1.7'=>'Fixed: Removal of equal signs from redirect urls',
			'1.6'=>'Background edits to eliminate some PHP notice messages',
			'1.5'=>'Fixed: New installs of version 1.4 failed to work correctly',
			'1.4'=>'Link alias support',
			'1.3'=>'UI changes|Fixed: Typos',
			'1.2'=>'Permissions check bug fix|Added additional notes to redirect file permissions (Settings screen)|Added footer links',
			'1.1'=>'Altered framework code to fit Wordpress Plugin Directory terms',
			'1.0'=>'Initial release of plugin'
		);
		
		$cw_redirect_it_whats_new_build='';
		foreach ($cw_redirect_it_whats_new as $cw_redirect_it_whats_new_version => $cw_redirect_it_whats_new_news) {
			$cw_redirect_it_whats_new_build .='<p>Version: <b>'.$cw_redirect_it_whats_new_version.'</b></p>';
			$cw_redirect_it_whats_new_news=preg_replace('/\|/','</li><li>',$cw_redirect_it_whats_new_news);
			$cw_redirect_it_whats_new_build .='<ul style="list-style: disc; margin-left: 25px;"><li>'.$cw_redirect_it_whats_new_news.'</li></ul>';
		}
...
$cw_plugin_hname='Cleverwise Redirect It';
print <<<EOM
<style type="text/css">
...
<div id="cws-nav" name="cws-nav">&#10058; <a href="?page=cw-redirect-it">Main Panel</a> &#10058; <a href="?page=cw-redirect-it&cw_action=settings">Settings</a> &#10058; <a href="?page=cw-redirect-it&cw_action=settingshelp">Help Guide</a> &#10058; <a href="?page=cw-redirect-it&cw_action=settingsnew">What Is New?</a></div>
